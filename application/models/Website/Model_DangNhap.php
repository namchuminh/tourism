...
class Model_DangNhap extends CI_Model {
	...
	public function add($tenkhachhang, $sodienthoai, $email, $taikhoan, $matkhau){
		$sql = "INSERT INTO `khachhang`(`TenKhachHang`, `SoDienThoai`, `Email`, `TaiKhoan`, `MatKhau`) VALUES (?, ?, ?, ?, ?)";
		$result = $this->db->query($sql, array($tenkhachhang, $sodienthoai, $email, $taikhoan, $matkhau));
		return $result;
	}
