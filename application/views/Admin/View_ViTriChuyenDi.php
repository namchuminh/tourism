...
<div class="page-content">
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Vị Trí Chuyến Đi</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Vị trí Chuyến Đi</h4>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <?php 
                                            ...
                                            $motadai = "";
                                            $bando = "";
                                            if(count($numberLocation) > 0){
                                                $motangan = $numberLocation[0]['MoTaNgan'];
                                                $motadai = $numberLocation[0]['MoTaDai'];
                                                $bando = $numberLocation[0]['BanDo'];
                                            }
                                         ?>
                                        <div class="form-group">
                                            <label for="simpleinput">Mô Tả Ngắn</label>
                                            <textarea required class="form-control"  name="motangan" rows="5"><?php echo $motangan; ?></textarea>
                                        </div> 

                                        <div class="form-group">
                                            <label for="simpleinput">Mô Tả Dài</label>
                                            <textarea required class="form-control" id="myTextarea" name="motadai"><?php echo $motadai; ?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Bản Đồ</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Dán iframe của Google Map" required name="bando" value="<?php echo $bando; ?>">
                                        </div>         
                                        
                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Cập Nhật Vị Trí</button>
                                    </form>
                                </div>
                                <!-- end card-body-->
                            </div>
