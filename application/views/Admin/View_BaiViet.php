                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                    		...
                                    		<tr role="row" class="odd">
	                                            ...
	                                            <td style="text-align: center;"><a href="<?php echo base_url('admin/bai-viet/sua/'.$value['MaBaiViet'].'/') ?>"><i style="font-size: 18px; color: #393f4e;" class="bx bx-detail"></i></a> </td>

	                                            <td style="text-align: center;"><a href="<?php echo base_url('admin/bai-viet/them-thung-rac/'.$value['MaBaiViet'].'/'); ?>"><i style="font-size: 18px; color: #393f4e;" class="bx bx-trash-alt"></i></a></td>
	                                        </tr>
                                    	<?php endforeach ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="dataTables_paginate paging_simple_numbers" id="basic-datatable_paginate">
                                    <ul class="pagination pagination-rounded">
                                        <?php for($i = 1; $i <= $totalPages; $i++){ ?>
                                       		<li style="margin-right: 5px;" class="paginate_button page-item"><a href="<?php echo base_url('admin/bai-viet/trang/'.$i.'/') ?>"
