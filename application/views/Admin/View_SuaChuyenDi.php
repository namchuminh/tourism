                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Sửa Chuyến Đi</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control tensanpham" placeholder="Tên chuyến đi" required name="tenchuyendi" value="<?php echo $detail[0]['TenChuyenDi']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="duongdan" class="form-control" placeholder="Đường dẫn chuyến đi..." required name="duongdan" value="<?php echo $detail[0]['DuongDan']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required class="form-control" name="motangan" rows="5"><?php echo $detail[0]['MoTaNgan']; ?></textarea>
                                        </div>
                                        ...
                                        <img id="anhchinhload" src="<?php echo $detail[0]['AnhChinh']; ?>" style="width: 400px; height: 300px;">
                                        <br>
                                        <br> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" id="simpleinput" class="form-control" placeholder="Nhập chi phí (VND)" required name="giachuyendi"value="<?php echo $detail[0]['GiaChuyenDi']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Nhập điểm khởi hành" required name="diemkhoihanh" value="<?php echo $detail[0]['DiemKhoiHanh']; ?>">
                                        </div>

                                        <div class="form-group row">
                                            <div class="col-6">
                                                <label for="simpleinput">Giờ Khởi Hành</label>
                                                <input type="date" id="simpleinput" class="form-control" placeholder="Nhập điểm khởi hành" required name="giokhoihanh" value="<?php echo $detail[0]['GioKhoiHanh']; ?>">
                                            </div>
                                            <div class="col-6">
                                                <label for="simpleinput">Giờ Quay Về</label>
                                                <input type="date" id="simpleinput" class="form-control" placeholder="Nhập điểm khởi hành" required name="gioquayve" value="<?php echo $detail[0]['GioQuayVe']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-6">
                                                ...
                                                <input type="number" id="simpleinput" class="form-control" placeholder="Nhập tuổi tham gia" required name="dotuoi" value="<?php echo $detail[0]['DoTuoi']; ?>">
                                                <span class="input-group-text" id="basic-addon2">trở lên</span>
                                        </div>
                                            </div>
                                            <div class="col-6">
                                                <label for="simpleinput">Quy Định Trang Phục</label>
                                                <input type="text" id="simpleinput" class="form-control" placeholder="Cách nhau bởi dấu phẩy ," required name="quydinhtrangphuc" value="<?php echo $detail[0]['QuyDinhTrangPhuc']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" id="simpleinput" class="form-control" placeholder="Cách nhau bởi dấu phẩy ," required name="baogom" value="<?php echo $detail[0]['BaoGom']; ?>">
                                            </div>
                                            <div class="col-6">
                                                <label for="simpleinput">Không Bao Gồm Dịch Vụ</label>
                                                <input type="text" id="simpleinput" class="form-control" placeholder="Cách nhau bởi dấu phẩy ," required name="khongbaogom" value="<?php echo $detail[0]['KhongBaoGom']; ?>">
                                            </div>
                                            
                                        </div>

                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Cập Nhật Chuyến Đi</button>
                                    </form>
                                </div>
                                <!-- end card-body-->
                            </div>
