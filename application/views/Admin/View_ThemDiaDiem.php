                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control tensanpham" placeholder="Tên địa điểm" required name="tendiemden">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="duongdan" class="form-control" placeholder="Đường dẫn địa điểm..." required name="duongdan">
                                        </div>        

                                       <div class="form-group">
                                       	    <label for="exampleFormControlSelect1">Mô Tả Địa Điểm</label>
                                            <textarea required class="form-control" id="myTextarea" name="mota"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                        	<div class="col-6">
	                                            ...
	                                            <div class="custom-file">
	                                                <input type="file" class="custom-file-input" required name="anhchinh">
                                            ...
                                            <div class="col-6">
	                                            ...
	                                            <div class="custom-file">
	                                                <input type="file" class="custom-file-input" required name="images[]" multiple>
                                        ...
                                        <div class="form-group row">
                                        	<div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="simpleinput" class="form-control" placeholder="Nhập tên quốc gia" required name="quocgia">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                        	<div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" id="simpleinput" class="form-control" placeholder="Nhập diện tích" required name="dientich">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="simpleinput" class="form-control" placeholder="Nhập đơn vị tiền" required name="donvitien">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                        	<div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="simpleinput" class="form-control" placeholder="Nhập ngôn ngữ" required name="ngonngu">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Thêm Địa Điểm</button>
                                    </form>
                                </div>
                                <!-- end card-body-->
                            </div>
