...
<div class="page-content">
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/tin-tuc/'); ?>">Bài Viết</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Nhập nội dung Bài Viết</h4>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="duongdan" class="form-control" placeholder="Đường dẫn Bài Viết..." required name="duongdan" value="<?php echo $detail[0]['DuongDan']; ?>">
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Cập Nhật Bài Viết</button>
                                    </form>
                                </div>
                                <!-- end card-body-->
                            </div>
